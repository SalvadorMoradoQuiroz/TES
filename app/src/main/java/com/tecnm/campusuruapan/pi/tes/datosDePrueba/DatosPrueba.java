...
public class DatosPrueba {
    ...
    public static List<Talachero> getListTalacheros(){
       ...
       /* Talachero t1 = new Talachero("Antonio Pulido Virrueta", "Francisco Villa #13, Colonia Centro, Uruapan Mich", 10, "","");
        Talachero t2 = new Talachero("Andres Mata Olivares", "Carranza #123, Colonia Centro, Uruapan Mich", 8, "","");
        Talachero t3 = new Talachero("Angel Araujo", "Francisco Villa #13, Colonia Centro, Uruapan Mich", 10, "","");
        Talachero t4 = new Talachero("Abel Vieyra Contreras", "Pedregal #25, Colonia Lomas de Uruapan, Uruapan Mich", 7, "","");
        Talachero t5 = new Talachero("Angel Contreras", "Francisco Villa #77, Colonia Centro, Uruapan Mich", 6, "","");
        Talachero t6 = new Talachero("Jose Francisco Torres", "Niños Herores #47, Colonia Sur, Uruapan Mich", 5, "","");
        Talachero t7 = new Talachero("Jesus Fuentes Leyba", "Francisco I Madero #52, Colonia Centro, Uruapan Mich", 7, "","");
        Talachero t8 = new Talachero("Brandon Gutierrez Vazquez", "Coronado #15, Colonia Centro, Uruapan Mich", 10, "","");
        Talachero t9 = new Talachero("Miriam Figueroa", "Villa #3, Colonia San Pedro, Uruapan Mich", 7, "","");
        Talachero t10 = new Talachero("Sara Dominguez ", "Juarez #47, Colonia Norte, Uruapan Mich", 8, "","");
